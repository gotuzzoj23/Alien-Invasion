...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    #print(len(bullets))  # Print statement to show how many bullet sexist in the game
...
def check_fleet_edges(ai_settings, aliens):
    """Respond appropriateluy if any aliens have reached an edge."""
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 1:    #if you make it equal to 0 it would traverse an extra time and give an extra life
